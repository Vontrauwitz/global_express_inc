        ...
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div className="py-2">
                <label htmlFor="jobCategory" className="sr-only">Job Category</label>
                <select
                  id="jobCategory"
                  name="jobCategory"
                  required
              ...
              {formData.jobCategory === 'Others' && (
                <div className="py-2">
                  <label htmlFor="otherJobCategory" className="sr-only">Other Job Category</label>
                  <input
                    id="otherJobCategory"
                    name="otherJobCategory"
                    type="text"
                    placeholder="Specify other job category"
                    value={formData.otherJobCategory}
                    onChange={handleChange}
                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border-blue-gray placeholder-blue-gray text-dark-blue focus:outline-none focus:ring-dark-blue focus:border-dark-blue focus:z-10 sm:text-sm"
                  />
                </div>
